...
//  NetworkHandler
//
//  Created by Balram Singh on 06/07/16.
...
class DataManager: NSObject {
    ...
    fileprivate static var _instance: DataManager? = DataManager()
    ...
    func getAllNotifications () -> [Notification] {
        ...
        do  {
            var arry = try self.managedObjectContext.fetch(fetchRequest) as? [Notification]
            arry?.sort { (n1, n2) -> Bool in
    ...
    func getNotifcationById (_ messageId : String) -> Notification? {
        let fetchRequest = NSFetchRequest<NSFetchRequestResult>(entityName: "Notification")
